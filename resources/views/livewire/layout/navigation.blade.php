...
<div>
    ...
    <nav class="fixed left-0 right-0 top-0 z-50 bg-white py-3 shadow-sm backdrop-blur-sm"
        style="font-family: 'Syne', sans-serif;" x-data="{ mobileMenuOpen: false }">
            ...
            <div class="flex h-16 items-center justify-between">
                ...
                <div class="hidden space-x-8 md:flex">
                    ...
                    <a href="{{ route('programs-and-products') }}" wire:navigate
                        ...
                        class="{{ request()->routeIs('programs-and-products') ? 'text-[#416910] border-b-2 border-[#416910]' : 'text-gray-700' }} px-3 py-2 text-sm font-medium transition-colors duration-200 hover:text-[#416910]">
                        Program & Products
                    </a>
                    <a href="{{ route('promotion') }}" wire:navigate
                        class="{{ request()->routeIs('promotion') ? 'text-[#416910] border-b-2 border-[#416910]' : 'text-gray-700' }} px-3 py-2 text-sm font-medium transition-colors duration-200 hover:text-[#416910]">
                        Informasi Promo
                    </a>
                    <a href="{{ route('articles') }}" wire:navigate
                        class="{{ request()->routeIs('articles') ? 'text-[#416910] border-b-2 border-[#416910]' : 'text-gray-700' }} px-3 py-2 text-sm font-medium transition-colors duration-200 hover:text-[#416910]">
                        Article
                    </a>
                    <a href="{{ route('galery-and-testimoni') }}" wire:navigate
                        class="{{ request()->routeIs('galery-and-testimoni') ? 'text-[#416910] border-b-2 border-[#416910]' : 'text-gray-700' }} px-3 py-2 text-sm font-medium transition-colors duration-200 hover:text-[#416910]">
